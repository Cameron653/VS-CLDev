...
/obj/item/weapon/archaeological_find/New(loc, var/new_item_type)
	...
	var/obj/item/weapon/secondary_item //Allows for more than one item to be found at a time. For sets of items that should be the same.
	var/source_material = ""
	...
	switch(find_type)
		...
		if(ARCHAEO_CUTLERY)
			...
			var/list/possible_cutlery = list(/obj/item/weapon/material/kitchen/utensil/fork,
		...
		if(ARCHAEO_HANDCUFFS)
			item_type = "handcuffs"
			var/list/possible_cuffs = list(/obj/item/weapon/handcuffs,
		...
		if(ARCHAEO_BEARTRAP)
			...
			apply_prefix = FALSE
			var/list/possible_trap = list(/obj/item/weapon/beartrap,
		...
		if(ARCHAEO_LIGHTER)
			...
			var/list/possible_lighter = list(/obj/item/weapon/flame/lighter,
		...
		if(ARCHAEO_GASTANK)
			item_type = "[pick("cylinder","tank","chamber")]"
			var/list/possible_tank = list(/obj/item/weapon/tank/air,
		...
		if(ARCHAEO_TOOL)
			item_type = "tool"
			var/list/possible_tool = list(/obj/item/weapon/tool/wrench/hybrid,
	...
	if(istype(secondary_item, /obj/item/weapon/material))
		var/new_item_mat = pickweight(list(
			MAT_STEEL = 80,
			MAT_WOOD = 20,
			MAT_SIFWOOD = 40,
	...
	if(apply_material_decorations)
		...
		if(istype(secondary_item, /obj/item/weapon/material))
			var/obj/item/weapon/material/SMW = secondary_item
